...
class WidgetService {
  ...
  static Future<void> updatePrayerWidget({
    ...
    if (prayerTimes['fajr'] != null)
      displayList.add('Fajr|${prayerTimes['fajr']}');
    if (prayerTimes['dhuhr'] != null)
      displayList.add('Dhuhr|${prayerTimes['dhuhr']}');
    if (prayerTimes['asr'] != null)
      displayList.add('Asr|${prayerTimes['asr']}');
    if (prayerTimes['maghrib'] != null)
      displayList.add('Maghrib|${prayerTimes['maghrib']}');
    if (prayerTimes['isha'] != null)
      displayList.add('Isha|${prayerTimes['isha']}');
    ...
    await HomeWidget.saveWidgetData<String>(
        'widget_prayer_data_v1', jsonEncode(jsonMap));
