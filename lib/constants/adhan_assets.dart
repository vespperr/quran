...
class AdhanAssets {
  ...
  static const List<AdhanAudioOption> allOptions = [
    AdhanAudioOption(
        label: 'أذان المكي - حجازي', rawName: 'bang_hijaz_maghrib_isha'),
    AdhanAudioOption(label: 'أذان حزين', rawName: 'adhan_kurd_2'),
    AdhanAudioOption(label: 'أذان رست ٢', rawName: 'bang_rast_2_nawrozh_asr'),
    AdhanAudioOption(
        label: 'أذان سنتى - بلال الحبشي', rawName: 'bang_bilali_habashi_fajr'),
    AdhanAudioOption(
        label: 'أذان م. رمضان شكور',
        rawName: 'bang_ramazan_shakur_fajr_maghrib'),
    AdhanAudioOption(label: 'أذان العراقي ٢', rawName: 'adhan_iraqi_new'),
    AdhanAudioOption(
        label: 'أذان صبا - السريحي', rawName: 'bang_saba_maghrib_isha_asr'),
    ...
    AdhanAudioOption(
        label: 'أذان كرد - آزاد الكردي', rawName: 'bang_kurd_fajr'),
  ];
