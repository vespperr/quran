...
class PdfBooksConstants {
  ...
  static const List<Map<String, String>> books = [
    ...
    {
      'path': '$basePath/english.pdf',
      'title':
          'Rullings and principles of call to prayer and call to start prayer'
    },
    {
      'path': '$basePath/persian.pdf',
      'title': 'آئینہ و قواعد بانگدان و قامەتێ'
    },
    {
      'path': '$basePath/arabic.pdf',
      'title': 'أحكام الأذان والإقامة على في مذاهب الأربعة'
    },
  ];
}
