...
class SecondaryAppBar extends StatelessWidget implements PreferredSizeWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return AppBar(
      ...
      leading: Row(
        children: [
          buildBackIconButton(context, iconColor),
          buildBookmarkButton(iconColor)
        ],
      ),
      leadingWidth: 100,
      actions: [
  ...
  GestureDetector buildAppBarTitle(BuildContext context,
      {Color? pillColor, Color? iconColor, String? fontFamily}) {
    ...
    return GestureDetector(
        onTap: () {
          showMaterialModalBottomSheet(
              context: context,
              builder: (_) =>
                  Consumer<SearchProvider>(builder: (context, _, child) {
                    return Container(
                          ...
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(
                                  ...
                                  borderRadius:
                                      BorderRadius.circular(kSizeXXL)),
                            ),
            ...
            children: [
              ...
              Text(
                ...
                style: context.theme.textTheme.bodyLarge!.copyWith(
                    color: textColor.withOpacity(0.9), letterSpacing: 0),
              ),
            ],
          ),
        ));
  ...
  IconButton buildBackIconButton(BuildContext context, Color? iconColor) {
    return IconButton(
      ...
      icon: SvgPicture.asset(
        ...
        height: 18,
        colorFilter:
            (iconColor ?? context.theme.appBarTheme.iconTheme?.color) != null
                ? ColorFilter.mode(
                    iconColor ?? context.theme.appBarTheme.iconTheme!.color!,
                    BlendMode.srcIn)
                : null,
      ),
    );
