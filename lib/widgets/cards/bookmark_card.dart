...
class _BookmarkCardState extends State<BookmarkCard>
  ...
  /// Bookmark card
  SlidableControllerSender buildBookmarkCard(BuildContext context) {
  ...
  Column buildSurahName(String surahName, String surahNameTranslation) {
    return Column(
  ...
  /// Surah ayat number
  Padding buildAyatNo(String ayatNo) {
    return Padding(
