...
class JuzSurahSearchWidget extends StatefulWidget {
  ...
  @override
  State<JuzSurahSearchWidget> createState() => _JuzSurahSearchWidgetState();
}

class _JuzSurahSearchWidgetState extends State<JuzSurahSearchWidget> {
  @override
